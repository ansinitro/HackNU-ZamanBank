...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                alert(data.detail || 'Login failed. Please check your credentials and try again.');
            }
        } catch (error) {
    ...
    return (
        <div
            className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#2D9A86] to-[#1a5d51] p-4">
            <div className="w-full max-w-md">
                {/* Logo/Brand Section */}
                <div className="text-center mb-8">
                    <div className="inline-block bg-white rounded-full p-4 mb-4 shadow-lg">
                        <div
                            className="w-16 h-16 bg-gradient-to-br from-[#2D9A86] to-[#EEFE6D] rounded-full flex items-center justify-center">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center">
                                <input
                                    type="checkbox"
                                    className="h-4 w-4 text-[#2D9A86] focus:ring-[#2D9A86] border-gray-300 rounded"
                                />
                                <span className="ml-2 text-sm text-gray-600">Remember me</span>
                            </label>
                            <a href="#" className="text-sm text-[#2D9A86] hover:text-[#1a5d51] font-medium">
                                Forgot password?
                            </a>
                        </div>
                  ...
                  Logging in...
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-600">
                            ...
                            <a href="/register" className="text-[#2D9A86] hover:text-[#1a5d51] font-semibold">
                                Sign up
                            </a>
                        </p>
                    </div>
