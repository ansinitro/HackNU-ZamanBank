      ...
      {showFilters && (
        <div className="p-4 sm:p-6 border-t" style={{ borderColor: `${ZamanColors.Solar}30` }}>
          <div className="space-y-4 sm:space-y-5">
            {/* Transaction Type */}
            <div>
              <label className="block text-xs sm:text-sm font-semibold mb-2 sm:mb-3" style={{ color: ZamanColors.PersianGreen }}>
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3">
                {[
                  ...
                  >
                    ...
                    <span className="sm:hidden">{label === 'Income' ? 'In' : label === 'Expense' ? 'Out' : 'All'}</span>
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
              {/* Category */}
              <div>
                <label htmlFor="category" className="block text-xs sm:text-sm font-semibold mb-2" style={{ color: ZamanColors.PersianGreen }}>
                  <div className="flex items-center gap-2">
