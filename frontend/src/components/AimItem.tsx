...
import { CheckCircle, TrendingUp, DollarSign, Edit, Trash2 } from 'lucide-react';
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 mb-4">
          <div className="flex items-start justify-between gap-2 mb-3">
            <div className="flex-1 min-w-0">
              <h3 className="text-lg sm:text-xl font-bold mb-1 break-words" style={{ color: ZamanColors.DarkTeal }}>
                {currentAim.title}
              </h3>
              {isCompleted && (
                <motion.span 
        ...
        >
          <DollarSign size={18} className="sm:w-5 sm:h-5 flex-shrink-0" style={{ color: ZamanColors.PersianGreen }} />
          <div className="flex-1 min-w-0">
            ...
            <div className="flex justify-between text-sm sm:text-base font-bold" style={{ color: ZamanColors.DarkTeal }}>
              <span className="truncate">${currentAim.current_amount.toFixed(2)}</span>
              <span className="text-gray-500 flex-shrink-0 ml-2">/ ${currentAim.target_amount.toFixed(2)}</span>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            >
              {modalType === 'increase' ? (
                <>
                  <TrendingUp size={20} className="sm:w-6 sm:h-6" style={{ color: ZamanColors.PersianGreen }} />
                  Add Amount
                </>
              ) : (
                <>
                  <DollarSign size={20} className="sm:w-6 sm:h-6" style={{ color: ZamanColors.PersianGreen }} />
                  Withdraw Amount
                </>
              )}
            </h2>
