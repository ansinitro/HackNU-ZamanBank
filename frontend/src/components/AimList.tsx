...
export default function AimList(): JSX.Element {
    ...
    return (
        <div className="space-y-4 sm:space-y-6 px-3 sm:px-0">
            ...
            {error && (
                <div
                    className="p-3 sm:p-4 rounded-lg sm:rounded-xl border-2 border-red-400 bg-red-50 text-red-700 font-medium">
                ...
                ▼
                        ...
                        {showInProgress && (
                            <div className="p-3 sm:p-6 grid gap-3 sm:gap-4"
                                 style={{backgroundColor: `${ZamanColors.Cloud}95`}}>
                                {inProgressAims.length === 0 ? (
                                    ...
                                    >
                                        ...
                                        <p className="text-xs sm:text-sm mt-2 opacity-75">Create your first financial
                                            goal to get started!</p>
                                    </div>
                                ) : (
                            ...
                            <div className="p-3 sm:p-6 grid gap-3 sm:gap-4"
                                ...
                                {completedAims.length === 0 ? (
                                    ...
                                    >
                                        ...
                                        <p className="text-xs sm:text-sm mt-2 opacity-75">Keep working towards your
                                            goals!</p>
                                    </div>
                                ) : (
                                    completedAims.map((a) => (
